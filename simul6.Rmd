...
Note: This document is generated from a Rmarkdown document (.Rmd) that can be processed with knitr and edited with rstudio.
...
```{r}
timing <- generate_paradigm_varying_SOA(ncond, trialpercond, stimduration, SOA, jitter=4, totalduration)
plot_paradigm(timing)
X <- create_design_matrix(timing, totalduration)
plot_design_matrix(X)
```
