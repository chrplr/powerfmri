...
timings <- data.frame(conditions=c(1,2,3,4), onsets=c(1, 3, 1, 3), durations=0)
X <- create_design_matrix(timings, totalduration=30)
par(mfcol=c(1,2))
plot(X[,1],type='l', col='blue', ylab='BOLD signal', xlab='Time (1/10sec)', bty='l', main='Model')
lines(X[,2], type='l', col='red')
legend('topright',c('sentence','probe'), col=c('blue','red'), lty=1, bty='n')

plot(X[,1],type='l', col='blue', ylab='MRI signal', xlab='Time ', bty='l', main='Estimation')
lines(0.3*X[,2], type='l', col='red')
lines(0.9*X[,3], type='l', col='blue', lty=3)
lines(0.2*X[,4], type='l', col='red', lty=3)
legend('topright',c('sent./Seq','probe/Seq','sent./Emb','probe/Emb'), col=c('blue','red'), lty=c(1,3), bty='n')
